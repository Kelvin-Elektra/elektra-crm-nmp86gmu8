...
export function ProposalCoverElegant({ data }: { data: ProposalPageData }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl bg-black/40 p-[12mm] rounded-3xl backdrop-blur-sm border border-white/20 shadow-2xl">
        <img src={logoUrl} alt="Logo" className="h-20 mx-auto mb-8 object-contain drop-shadow-lg" />
        <h1 className="text-4xl font-bold mb-3 tracking-tight text-center">Proposta Comercial</h1>
        <h2 className="text-lg font-light text-blue-100 mb-8 text-center">
